...
electronics_box (box_size_y = 300, box_size_z = 350, box_depth = 87, acrylic_thickness = 6); // New ZL
...
color(acrylic_color())
	{
		difference()
		{
			...
			mirror_x() 
			{
				translate ([length/2 - 19,box_depth, -15]) cylinder(h=30, r1=7.5, r2=7.5, center=false); 
			}
			}
			if (IEC == true){		
