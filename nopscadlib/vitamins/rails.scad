...
MGN12_short_ca = [ 34.7, 21.7, 27, 13, 3,   15, 20, M3_cap_screw ];
MGN15_carriage = [ 43.3, 27.7, 32, 16, 4,   20, 25, M3_cap_screw ];
LAS15_carriage = [ 56.8, 40.4, 34, 19.4,4.6,26,26, M3_cap_screw ];
...
LAS15= [ "LAS15", 15, 12.5,10,  60, 6.0, 3.5, 4.5, M3_cap_screw,   LAS15_carriage, M3_cs_cap_screw ];
