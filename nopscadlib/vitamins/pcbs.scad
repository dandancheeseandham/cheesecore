...
Duet3E = ["Duet3E", "Duet 3 Ethernet electronics",
                                     140,   134,   1.6, 0,    4.3,  0, "#2140BE",  false, [[-5, 5], [-5, -5], [5, -5],[5, 5]],
                                                                    [[ 18.5, -75.5-18.3, 0, "pcb", 5, Ethernet],
                                                                     [  2.0, -70.5, 180, "usb_uA"],
                                                                     [  89.4, -126.3, 270, "uSD", [15, 14.5, 2]],
                                                                     [ 2.3,  -30.2,   0, "chip", 3.6, 4.8, 2.0, "silver"],  // Reset switch
                                                                     [ 0.0,  -30.2,   0, "chip", 2.0, 2.6, 1.4, grey20],    // Reset button
                                                                    ],
                                                                    [": Micro SD card", ": Cat 5 patch cable 300mm"]];
...
Duet3Exp = ["Duet3Exp", "Duet3 expansion board",
                                  100,   100,   1.6, 0,    4.3,  0, "#2140BE",  false, [[-4.5, 4.5], [-4.5, -4.5], [4.5, -4.5],[4.5, 4.5]],
                                                                                                                                       [ ],
                                                                                                                                        []];
